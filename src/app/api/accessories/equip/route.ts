 ...
 * Body: { monsterId: string, accessoryId: string, category: 'hat' | 'glasses' | 'shoes' | 'background' }
 *
...
export async function POST(request: Request): Promise<NextResponse> {
  try {
    ...
    const validCategories = ["hat", "glasses", "shoes", "background"] as const
    ...
    const updateField =
      category === "hat"
        ...
        : "equippedAccessories.background"
